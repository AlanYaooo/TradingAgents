...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    # Output language for ALL agent output (analyst reports, the bull/bear and
    # risk debates, and the final decision). A non-English value localizes every
    # report-producing agent via get_language_instruction().
    ...
    "benchmark_map": {
        ...
        ".BJ":  "899050.BJ",   # Beijing Stock Exchange (BSE 50)
